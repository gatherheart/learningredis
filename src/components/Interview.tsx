...
export function Interview() {
  ...
  return (
    <main className="app-scrollbar flex-1 overflow-y-auto bg-[radial-gradient(circle_at_top_right,rgba(56,189,248,0.16),transparent_24%),linear-gradient(180deg,rgba(4,8,12,0.86),rgba(4,8,12,0.98))]">
        ...
        <section className="grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_minmax(340px,0.75fr)]">
          <div className="rounded-[30px] border border-white/10 bg-zinc-950/85 p-6 shadow-2xl shadow-black/25">
            ...
            <div className="mt-4 max-w-3xl space-y-3 text-base leading-8 text-zinc-300">
              <p>This section is for explanation-heavy Redis reasoning beyond isolated command syntax.</p>
              <p>The emphasis is on choosing data structures, separating pipelines from transactions, handling cluster constraints, and asking the right failure questions at senior level.</p>
            </div>
          </div>
          <div className="rounded-[30px] border border-white/10 bg-[#0a121a] p-5 shadow-2xl shadow-black/20">
            ...
            <div className="space-y-3 text-sm leading-7 text-zinc-300">
              <p>Junior questions test primitive selection and TTL intuition.</p>
              <p>Mid questions move into cache patterns, network round trips, and command semantics.</p>
              <p>Senior questions focus on cluster design, topology, and operational risk.</p>
            </div>
          </div>
        </section>
